defmodule LooksLikeANailBackend.MapperTest do
  ...
  test "map tools" do
    ...
    expected = %{tools: [
      ...
      features: [
        %{ title: "herokuHosting", id: 305, created: "2015-07-21T23:52:06.931Z", updated: "2015-07-21T23:52:06.931Z", capability: 202, supports: [105, 104]},
        %{ title: "ecto", id: 302, created: "2015-07-21T23:52:06.931Z", updated: "2015-07-21T23:52:06.931Z", capability: 204, supports: [106,105]}],
      capabilities: [
      ...
      concepts: [
        %{id: 105, title: "Postgres", subTitle: "Database", description: "PostgreSQL, often simply Postgres, is an object-relational database...", created: "2015-07-21T23:52:06.931Z", updated: "2015-07-21T23:52:06.931Z"},
        %{id: 104, title: "Elixir", subTitle: "Programming Language", description: "Elixir is a functional, concurrent, general-purpose programming language...", created: "2015-07-21T23:52:06.931Z", updated: "2015-07-21T23:52:06.931Z"},
        %{id: 106, title: "MySQL", created: "2015-07-21T23:52:06.931Z", updated: "2015-07-21T23:52:06.931Z", subTitle: "Database", description: "MySQL (/maɪ ˌɛskjuːˈɛl/ 'My S-Q-L',[6] officially..." }
        ]
    }
  ...
  test "map one tool two rows" do
    ...
    expected = %{ tool: %{id: 104, title: "Elixir", subTitle: "Programming Langugage", updated: "2015-07-29T19:18:45.156Z", created: "2015-07-21T23:52:06.931Z", description: "Elixir is a functional...", features: [302]},
      features: [%{id: 302, title: "ecto", updated: "2015-07-21T23:52:06.931Z", created: "2015-07-21T23:52:06.931Z", capability: 204, supports: [105,106]}],
      ...
      concepts: [%{title: "Postgres", id: 105, created: "2015-07-21T23:52:06.931Z", updated: "2015-07-29T18:34:04.405Z", subTitle: "Database", description: "PostgreSQL, often simply Postgres..." },
    ...
    # assert expected[:supports] === actual[:supports]
    assert expected[:concepts] === actual[:concepts]
  end
  ...
  test "map one tool one row" do
    ...
    expected = %{ tool: %{id: 104, title: "Elixir", subTitle: "Programming Langugage", updated: "2015-07-29T19:18:45.156Z", created: "2015-07-21T23:52:06.931Z", description: "Elixir is a functional...", features: [302]},
      feature: %{id: 302, title: "ecto", updated: "2015-07-21T23:52:06.931Z", created: "2015-07-21T23:52:06.931Z", capability: 204, supports: [106]},
      capability: %{id: 204, title: "Connecting", updated: "2015-07-21T23:52:06.931Z", created: "2015-07-21T23:52:06.931Z", subTitle: "Capability", description: "ConnectingDescription"},
  ...
  test "map single entity with no features" do
    ...
    expected = %{ tool: %{id: 101, title: "Java", subTitle: "Programming Language", updated: "2015-07-29T18:38:34.593Z", created: "2015-07-21T23:52:06.931Z", description: "Java is a general-purpose computer programming language...", features: []},
      features: [], capability: [], concepts: []}
    IO.inspect actual = Mapper.map_single_entity(Tool, [row], @columns)
    assert_equal_except(expected, actual)
  ...
  test "convert list field" do
    input = %{"list" => [1,2]}
    expected = %{list: [1,2]}
    actual = Mapper.convert_fields(input)
    assert expected === actual
  end
